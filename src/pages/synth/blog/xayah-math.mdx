...
### Live Values
**Essence Reaver + Infinity Edge + Berserker's** (*7800g*)
...
### PBE Values
**Kraken Slayer + Infinity Edge + Berserker's** (*7900g*)
...
I do think that 3 items+, Xayah starts to look better and better, but this definitely misses the *goal* of the marksman item update, which
Mark Yetter described as to "bring a bit more power into the early curve and slightly less exponential payoff."
